...
// 	return (
// 		<section className={cn(className, 'about')}>
// 			<div className='sm:container mx-auto py-5 px-3'>
// 				<Title
// 					className=' text-[36px] sm:text-[50px] md:text-[56px] font-semibold'
// 					title='О компании'
// 				/>
// 				<ul className='py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6'>
// 					{data.map((item, index) => {
// 						if (item.src) {
// 							// Карточка с изображением - занимает всю ширину колонки
// 							return (
// 								<li
// 									key={index}
// 									className={cn(
...
// 										src={item.src}
// 										alt={item.title}
// 										className='absolute object-bottom-right  bottom-0 right-0 h-[110%] xs:h-full sm:h-[75%] 2xl:h-[85%]	 max-w-full object-contain '
// 									/>
// 									<div className='w-1/2'>
// 										<h3 className='hidden xs:block font-bebas text-5xl 2xl:text-6xl font-medium text-white'>
// 											{item.title}
// 										</h3>
// 									</div>
// 								</li>
...
// 								>
// 									<h3
// 										className={`font-bebas text-3xl medium mb-3 md:mb-4 ${
// 											item.resize ? 'md:text-[37px]' : 'md:text-5xl'
// 										} xl:text-5xl`}
// 									>
// 										{item.title}
// 									</h3>
// 									<p className='text-gray-600 text-sm md:text-xl font-semibold leading-5'>
// 										{item.desc}
// 									</p>
// 								</li>
// 							)
