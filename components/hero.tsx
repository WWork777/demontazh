    ...
    >
      <div className='bg-[url("/img/hero_bg.png")] h-full w-full rounded-[20px] xl:rounded-[33px] 2xl:rounded-[58px] mx-3 lg:mx-8 xl:mx-16 bg-cover bg-top relative overflow-hidden px-2 lg:px-0'>
        ...
        <div className="relative z-10 text-white h-full flex flex-col  justify-around xs:justify-evenly md:justify-center md:gap-12 md:px-5 lg:px-10 xl:p-0 xl:pl-28">
          ...
          <motion.div
            className="p-5 lg:p-8 rounded-[23px] backdrop-blur-[22.7px] bg-[rgba(16,22,17,0.52)] max-w-6xl flex flex-col lg:flex-row gap-3 justify-between xl:items-center md:mx-auto xl:mx-0 md:w-full"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.8 }}
          >
            <p className=" xs:text-lg lg:text-2xl font-normal leading-5 text-center xl:text-left xl:leading-7">
              Рассчитайте предварительную <br />
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center xl:justify-end">
              ...
              <Button
                className="xs:text-lg lg:text-xl px-5 lg:px-10 py-3 lg:py-5 rounded-[14px] bg-(--accent-color1) text-white font-semibold hover:opacity-90 transition-opacity"
                icon={<IoChevronForwardSharp className="text-2xl" />}
                text="Расчет стоимости демонтажа"
                link="/#calc"
              />
            </div>
          </motion.div>
